...
export function Hero(){
	return(
		<div className="max-sm:flex flex-col items-center justify-center w-full h-screen bg-center" style={{backgroundImage: 'url("https://www.creativeuncut.com/gallery-18/art/mk9-background-mileena.jpg")'}}>
